...
import com.github.mem64bits.simple.metronome.commands.DecreaseBpm;
import com.github.mem64bits.simple.metronome.commands.IncreaseBpm;
import com.github.mem64bits.simple.metronome.commands.PauseCommand;
import com.github.mem64bits.simple.metronome.input.InputBinder;
import com.github.mem64bits.simple.metronome.input.InputHandler;
...
import com.github.mem64bits.simple.metronome.ui.ScreenFlasher;
...
public class MetronomeApp extends ApplicationAdapter {
    ...
    // Specialised Observer detecting when to play audio
    ...
    public void create() {
        ...
        soundRegistry.registerSound(defaultBeat.getName(), defaultBeat);
